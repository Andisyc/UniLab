...
def _fake_env(reward_cfg: G1WalkRewardConfig) -> G1WalkEnv:
    ...
    env._backend = _FakeBackend(
        {
            "left_foot_pos": np.asarray([[0.0, 0.0, 0.5]], dtype=np.float32),
            "right_foot_pos": np.asarray([[0.0, 0.0, 0.5]], dtype=np.float32),
            "left_foot_contact_0": np.asarray([0.0], dtype=np.float32),
            "left_foot_contact_1": np.asarray([0.0], dtype=np.float32),
            "left_foot_contact_2": np.asarray([0.0], dtype=np.float32),
            "left_foot_contact_3": np.asarray([0.0], dtype=np.float32),
            "right_foot_contact_0": np.asarray([0.0], dtype=np.float32),
            "right_foot_contact_1": np.asarray([0.0], dtype=np.float32),
            "right_foot_contact_2": np.asarray([0.0], dtype=np.float32),
            "right_foot_contact_3": np.asarray([0.0], dtype=np.float32),
        }
    )
    return env
